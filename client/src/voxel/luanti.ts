...
export const BLOCK_GROUPS: Record<number, Groups> = {
  ...
  95: { cracky: 2 }, // mese ore (stone pick+; deep + rare)
  96: { cracky: 1, level: 2 }, // mese block
  ...
  66: { cracky: 2 }, // stone brick
  67: { crumbly: 2, cracky: 3 }, // sandstone brick
...
export const TOOLS: Record<string, ToolCaps> = {
  ...
  axe_diamond: { full_punch_interval: 0.9, groupcaps: { choppy: { times: { 1: 2.1, 2: 0.9, 3: 0.5 }, maxlevel: 3 } } },
  axe_mese: { full_punch_interval: 0.9, groupcaps: { choppy: { times: { 1: 2.2, 2: 1.0, 3: 0.6 }, maxlevel: 3 } } },
  ...
  shovel_diamond: { full_punch_interval: 1.0, groupcaps: { crumbly: { times: { 1: 1.1, 2: 0.5, 3: 0.3 }, maxlevel: 3 } } },
  shovel_mese: { full_punch_interval: 1.0, groupcaps: { crumbly: { times: { 1: 1.2, 2: 0.6, 3: 0.3 }, maxlevel: 3 } } },
  ...
  sword_diamond: { full_punch_interval: 0.7, groupcaps: { snappy: { times: { 1: 1.9, 2: 0.9, 3: 0.3 }, maxlevel: 3 } } },
  sword_mese: { full_punch_interval: 0.7, groupcaps: { snappy: { times: { 1: 2.0, 2: 1.0, 3: 0.35 }, maxlevel: 3 } } },
