...
- Used files (renamed): `blocks/*.png` (grass/dirt/stone/sand/tree/leaves/brick;
  ...
  dandelion, dry shrub, cactus, papyrus, mushrooms, geranium, viola; wheat crop stages, straw; sapling; soil, desert soil; stone/sandstone/obsidian brick, bookshelf, steel block, tnt), `items/*.png` (wood/stone/
