 ...
 *   - mapBridge.ts reads them off a FurnitureObject → the instance override
...
import { type PropBag } from './actionProps.js';
...
export const FURNITURE_TILE_PROPS: ReadonlyArray<{
  ...
  { name: 'canWalkOver', default: false },
...
export function furnitureBehaviourFromTile(props: PropBag): {
  ...
  return {
    ...
    ...(props.canWalkOver === true ? { canWalkOver: true } : {}),
...
export function furnitureBehaviourFromObject(props: PropBag): Partial<PlacedFurniture> {
  ...
  return {
    ...
    ...(typeof props.canWalkOver === 'boolean' ? { canWalkOver: props.canWalkOver } : {}),
