...
import { LayoutManagerModal } from './components/LayoutManagerModal.js';
  ...
  return (
    <div ref={containerRef} className="w-full h-full relative overflow-hidden">
      ...
      <BottomToolbar
        ...
        onToggleLayouts={() => setIsLayoutsOpen((v) => !v)}
      ...
      <LayoutManagerModal
        ...
        layouts={layouts}
        active={activeLayout}
        isDirty={editor.isEditMode && editor.isDirty}
        getCurrentLayout={() =>
          getOfficeState().getLayout() as unknown as Record<string, unknown>
        }
      />
